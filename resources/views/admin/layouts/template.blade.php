...
<head>
  ...
  <title>@yield('pagetitle') - Levents </title>
  <!-- General CSS Files -->
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a class="nav-link" href="{{ route('admin.allproducts') }}"><i data-feather="file"></i><span>All Product</span></a></li>
            <li class="dropdown">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="mail"></i><span>User</span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="{{ route('pendingorder') }}">Order Manage</a></li>
              </ul>
            </li>
            <li class="dropdown">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i
              ...
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="{{ route("admin.addsupplier") }}">Create Supplier</a></li>
                <li><a class="nav-link" href="{{ route('admin.allsupplier') }}">All Supplier</a></li>
                <li><a class="nav-link" href="{{ route('admin.createsupply') }}">Supply</a></li>
                <li><a class="nav-link" href="{{ route('admin.allsupply') }}">All Supply</a></li>
              </ul>
            </li>
            <li class="dropdown">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i
              ...
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="{{ route("admin.createblog") }}">Create Category Blog</a></li>
                <li><a class="nav-link" href="{{ route('admin.allblog') }}">All Category Blog</a></li>
                <li><a class="nav-link" href="{{ route('admin.createblogpost') }}">Blog Post</a></li>
                <li><a class="nav-link" href="{{ route('admin.allblogpost') }}">All Blog Post</a></li>
              </ul>
            </li>
          </ul>
        </aside>
